  ...
  return (
    <div className={cx("footer")}>
      <div className={cx("leftBlock")}>
        ...
        <div className={cx("textLight", "developerName")}>
          Валерия Абуткина, 2022
        </div>
      </div>
      <div className={cx("icons")}>
        <div>
          ...
          >
            <img
              src={theme === "light" ? facebook : facebookForDark}
              alt="facebook"
              className={cx("icon")}
            />
          </a>
        ...
        <div>
          ...
          >
            <img
              src={theme === "light" ? instagram : instForDark}
              alt="instagram"
              className={cx("icon")}
            />
          </a>
